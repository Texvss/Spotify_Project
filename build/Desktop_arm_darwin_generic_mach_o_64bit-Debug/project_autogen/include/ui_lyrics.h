...
public:
    ...
    void setupUi(QWidget *Lyrics)
    {
        ...
        verticalSpacer_2 = new QSpacerItem(20, 5, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
...
""));
        ...
        lyricsList->setMinimumSize(QSize(600, 426));
        lyricsList->setMaximumSize(QSize(600, 426));
...
"background: #101010;"));
        ...
        verticalSpacer_3 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_2 = new QSpacerItem(470, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
