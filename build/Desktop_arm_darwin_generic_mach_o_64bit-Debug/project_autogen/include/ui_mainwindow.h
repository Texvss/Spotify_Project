...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        searchLine->setMinimumSize(QSize(230, 0));
        searchLine->setMaximumSize(QSize(230, 16777215));
        QFont font;
...
"background-color: #717072;"));
        ...
        horizontalSpacer_3 = new QSpacerItem(148, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_3);

        likedButton = new QPushButton(centralwidget);
        likedButton->setObjectName("likedButton");
        likedButton->setMinimumSize(QSize(40, 0));
        likedButton->setMaximumSize(QSize(100, 16777215));
        QFont font1;
        ...
        horizontalSpacer_4 = new QSpacerItem(217, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_4);

        userLabel = new QLabel(centralwidget);
        userLabel->setObjectName("userLabel");
        userLabel->setMinimumSize(QSize(150, 0));
        userLabel->setMaximumSize(QSize(150, 16777215));
...
""));
        ...
        horizontalSpacer_8 = new QSpacerItem(0, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_5 = new QSpacerItem(478, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        verticalSpacer_2 = new QSpacerItem(20, 0, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_2 = new QSpacerItem(0, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
